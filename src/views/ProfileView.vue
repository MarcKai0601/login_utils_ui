    ...
    <div class="grid gap-6 md:grid-cols-2 max-w-4xl">
      ...
      >
        <div class="flex items-center gap-3 mb-5">
          ...
          <div>
            <h2 class="text-sm font-semibold" style="color: var(--body-text)">RBAC Roles</h2>
            <p class="text-xs" style="color: var(--sidebar-text)">Assigned roles across systems</p>
          </div>
        </div>

        <div v-if="authStore.roles.length > 0" class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          <div
          ...
          >
            ...
            <div>
              <p class="text-sm font-medium" style="color: var(--body-text)">{{ role.roleName }}</p>
              <p class="text-xs" style="color: var(--sidebar-text)">{{ role.systemCode }}</p>
            </div>
          </div>
        </div>
        ...
        <div v-else class="text-center py-6">
          ...
          <p class="text-sm" style="color: var(--sidebar-text)">No roles assigned yet</p>
          <p class="text-xs mt-1" style="color: var(--sidebar-text); opacity: 0.6">Contact administrator to assign roles</p>
        </div>
      </div>
    </div>
  </div>
